...
\EducationEntry{ORISE Fellow}{2019 - Present}{Center for Disease Control and Prevention}
{\begin{itemize}\item{Surveillance, Information Management, and Statistics Office - Statistics and Machine Learning: research on anomaly cluster detection using genome sequencing data and linked epidemiological data}\end{itemize}}
\NewPart{Past employment}{}
\EducationEntry{Postdoctoral Research Associate}{2015 - 2019}{Carnegie Mellon University}
...
\item \ManEntry{\textbf{Tian D}$^\star$, Zhu X$^\star$, and Ma J}{Diffdomains: random matrix theory supported identification of significantly reshaped chromatin domains from Hi-C contact matrices between normal and disease conditions}
