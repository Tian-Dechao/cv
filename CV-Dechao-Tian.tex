...
oyy5@cdc.gov\\https://tian-dechao.github.io}
...
\EducationEntry{Mathematical Statistician}{2019 - Present}{Centers for Disease Control and Prevention, US}
...
\begin{etaremune}
\item \ManEntry{\textbf{Tian D}$^\star$, Zhang R$^\star$, Zhang Y, and Ma J}{MOCHI enables discovery of heterogeneous interactome modules in 3D nucleome. bioRxiv, doi: https://doi.org/10.1101/542092. Resubmitted to \textit{Genome Research}}
\item \ManEntry{\textbf{Tian D}$^\star$, Zhu X$^\star$, and Ma J}{
        Diffdomains: Discovery of statistically significantly reshaped chromatin domains using random matrix theory
    }
