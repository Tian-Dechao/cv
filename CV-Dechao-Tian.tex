...
Shenzhen, Guangdong 510275
}{
tiandch@mail.sysu.edu.cn\\http://dechaotian.com}
...
\EducationEntry{Associate Professor}{2020 - Present}{School of Public Health (Shenzhen), Sun Yat-sen University, China}
{\begin{itemize}\item{ Method development for 3D chromatin organization} \item{Machine learning applications in precision public health} \end{itemize}}
\NewPart{Past employment}{}
\EducationEntry{Mathematical Statistician}{2019 - 2020}{Centers for Disease Control and Prevention, US}
{\begin{itemize}\item{Surveillance, Information Management, and Statistics Office: research on anomaly cluster detection using heterogeneous and high dimensional time-to-event data}\end{itemize}}
\EducationEntry{Postdoctoral Research Associate}{2015 - 2019}{Carnegie Mellon University, US}
{\begin{itemize}\item{Computational Biology Department: research on regulatory network and 3D chromatin organization by developing advanced statistical and machine learning algorithms}\end{itemize}}
...
%\begin{etaremune}
%%\item \ManEntry{\textbf{Tian D}$^\star$, Zhu X$^\star$, and Ma J}{Diffdomains: model-based identification of significantly reshaped chromatin domains between normal and disease conditions}
...
\begin{etaremune}
\item \PaperEntry{Zhu X$^\star$, Zhang Y$^\star$, Wang Y, \textbf{Tian D}, Belmont A, Swedlow J, Jian M}{Nucleome Browser: An integrative and multimodal data navigation platform for 4D Nucleome}{Nature Methods}{}{}{2022}{}
\item \PaperEntry{Hua D$^\star$, Hua D$^\star$, Hua D$^\star$, Qi L, Du X, Bai ZD, Zhu X, \textbf{Tian D}}{Diffdomains: Discovery of statistically significantly reshaped chromatin domains using random matrix theory}{RECOMB 2022, LNBI}{13278}{}{2022}{}
\item \PaperEntry{\textbf{Tian D}$^\star$, Zhang R$^\star$, Zhang Y, and Ma J}{MOCHI enables discovery of heterogeneous interactome modules in 3D nucleome}{Genome Research}{30}{2}{2020}{}
...
\SkillsEntry{Bioinformatics tools \& databases}{
    Cytoscape, MEME Suite, BEDTools, JUCIER, UCSC Genome Browser, ENCODE, TCGA }

%\NewPart{Presentation}{}
%\begin{etaremune}
%\item  \TalkEntry{DRIVE: an open source web application using \underline{D}ata \underline{R}eduction for \underline{I}nteractive \underline{V}isualization and Analysis of \underline{E}pidemiologic and Genomic Data }{DataViz day}{CDC}{2019}
%\end{etaremune}


\NewPart{Posters}{}
\begin{etaremune}
\item  \PosterEntry{Advanced Molecular Detection day}{CDC}{2019}
\item  \PosterEntry{Systems Biology, Global Regulation $\&$ Gene Expression}{CSHL}{2018}
\item  \PosterEntry{4DN Annual Meeting}{NIH}{2017}
\end{etaremune}

%\NewPart{References}{}
%%\ReferenceEntry{Anna Blackstock, Ph.D.}{Mathematical Statistician\\Centers for Disease Control and Prevention}{Division of Foodborne, Waterborne, and Environmental Diseases\\Centers for Disease Control and Prevention\\ 1600 Clifton Rd NE\\Atlanta, GA 30329, USA\\Tel:(404) 718-4720\\hyp9@cdc.gov} 
%%\sepspace
...
%%\sepspace
%\ReferenceEntry{Kwok Pui Choi, Ph.D.}{Professor, Statistics\\ National University of Singapore, Singapore}{National University of Singapore, 6 Science Drive 2, Singapore 117546\\Tel:(+65) 6516-4387\\stackp@nus.edu.sg}
%\sepspace
