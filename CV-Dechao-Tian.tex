...
{\begin{itemize}\item{Surveillance, Information Management, and Statistics Office - Machine Learning: research on anomaly cluster detection}\end{itemize}}
...
\begin{etaremune}
\item \ManEntry{\textbf{Tian D}$^\star$, Zhang R$^\star$, Zhang Y, and Ma J}{MOCHI enables discovery of heterogeneous interactome modules in 3D nucleome. bioRxiv, doi: https://doi.org/10.1101/542092. Preparing for resubmission to \textit{Genome Research}}
